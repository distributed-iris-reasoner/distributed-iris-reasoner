...
/**
 * <p>
 * Represents the RIF built-in function func:concatenate.
 * </p>
 * <p>
 * Returns a list consisting of all the items in <code>list_1</code>, followed
 * by all the items in <code>list_i</code>, for each <code>i <= n</code>.
 * </p>
 * see <A HREF=
 ...
 * 
 */
public class ConcatenateBuiltin extends AbstractBuiltin {

	private static final String PREDICATE_STRING = "CONCATENATE";
	 ...
	 */
	public ConcatenateBuiltin(ITerm... terms) {
