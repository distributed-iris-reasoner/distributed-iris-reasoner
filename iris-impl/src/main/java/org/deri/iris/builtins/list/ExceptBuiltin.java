 ...
 * <code>list_1</code> and not in <code>list_2</code>. The order of the items is
 * the same as in <code>list_1</code>.
 * </p>
 * see <A HREF=
 ...
 * 
 */
public class ExceptBuiltin extends AbstractBuiltin {

	/** The predicate defining this built-in. */
	private static final IPredicate PREDICATE = BASIC.createPredicate("EXCEPT",
			2);
