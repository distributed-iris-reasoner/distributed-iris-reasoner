 ...
 * type instances to {@link IDateTimeStamp} instances. The following data types are supported:
 * <ul>
 * <li>Date</li>
 * </ul>
 */
public class ToDateTimeStampBuiltin extends ConversionBuiltin {
	 ...
	 * 
	 * @param terms The term representing the data value to be
	 *            converted.
	 */
	 ...
	 * @return A new DateTimeStamp term representing the result of the conversion.
	 */
	public static IDateTime toDateTimeStamp(IDateTime term) {
		...
		return CONCRETE.createDateTimeStamp(term.getYear(), term.getMonth(), term
