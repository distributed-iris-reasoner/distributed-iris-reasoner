...
/**
 * <p>
 * Represents the RIF built-in function func:append.
 * </p>
 * <p>
 * Returns a list consisting of all the items in <code>list</code>, followed by
 * <code>item_i</code>, for each <code>i</code>, 1 <= i <= n.
 * </p>
 * see <A HREF=
 ...
 * 
 */
public class AppendBuiltin extends AbstractBuiltin {

	private static final String PREDICATE_STRING = "APPEND";
	 ...
	 */
	public AppendBuiltin(ITerm... terms) {
	...
	protected ITerm computeResult(ITerm... terms) {
		return ListBuiltinHelper.append(terms);
	}
