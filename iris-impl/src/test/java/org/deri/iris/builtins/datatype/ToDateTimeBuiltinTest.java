...
/**
 * Test for ToDateTimeBuiltin.
 */
public class ToDateTimeBuiltinTest extends TestCase {

	private static final ITerm X = TERM.createVariable("X");

	private static final ITerm Y = TERM.createVariable("Y");

	public ToDateTimeBuiltinTest(String name) {
		super(name);
	}
	...
	public void testDate() throws EvaluationException {
		equals(CONCRETE.createDateTime(2009, 04, 27, 0, 0, 0, 0, 0), CONCRETE
				.createDate(2009, 04, 27));
		equals(CONCRETE.createDateTime(2009, 04, 27, 0, 0, 0, 5, 0), CONCRETE
				.createDate(2009, 04, 27, 5, 0));
	}

	public void testDateTime() throws EvaluationException {
		equals(CONCRETE.createDateTime(2009, 04, 27, 10, 10, 0, -5, 0),
	...
	private void equals(IDateTime expected, ITerm term)
