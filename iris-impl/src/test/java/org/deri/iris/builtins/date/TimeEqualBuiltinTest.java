...
/**
 */
public class TimeEqualBuiltinTest extends AbstractDateBuiltinTest {

	public TimeEqualBuiltinTest(String name) {
		super(name);
	}
	...
	public void testBuiltin() throws EvaluationException {
		...
		// time1 = time1
		TimeEqualBuiltin builtin = new TimeEqualBuiltin(X, Y);
		...
		// time1 = time2
		builtin = new TimeEqualBuiltin(X, Y);
