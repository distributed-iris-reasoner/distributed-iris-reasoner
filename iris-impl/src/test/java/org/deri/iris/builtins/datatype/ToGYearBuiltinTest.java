...
/**
 * Test for ToGYearBuiltin.
 */
public class ToGYearBuiltinTest extends TestCase {
	...
	public void testDate() throws EvaluationException {
		equals(CONCRETE.createGYear(2009), CONCRETE.createDate(2009, 04, 27));
		equals(CONCRETE.createGYear(2009), CONCRETE.createDate(2009, 04, 27, 5,
				0));
	}

	public void testDateTime() throws EvaluationException {
		equals(CONCRETE.createGYear(2009), CONCRETE.createDateTime(2009, 04,
				27, 10, 10, 0, -5, 0));
	}
	...
	public void testGYear() throws EvaluationException {
		equals(CONCRETE.createGYear(2009), CONCRETE.createGYear(2009));
	}
