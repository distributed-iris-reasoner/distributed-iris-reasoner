...
/**
 * Test for ToStringBuiltin.
 */
public class ToStringBuiltinTest extends TestCase {

	private static final ITerm X = TERM.createVariable("X");

	private static final ITerm Y = TERM.createVariable("Y");

	public ToStringBuiltinTest(String name) {
		super(name);
	}
	...
	public void testSqName() throws EvaluationException {
		...
		equals("http://www.w3.org/2001/XMLSchema#double", name);
	}
	...
	public void testXMLLiteral() throws EvaluationException {
		equals("<quote>Bam!</quote>", CONCRETE.createXMLLiteral(
				"<quote>Bam!</quote>", "de"));
	}
	...
	private void equals(String expected, ITerm term) throws EvaluationException {
		ITuple expectedTuple = BASIC.createTuple(TERM.createString(expected));
	...
	private ITuple compute(ITerm term) throws EvaluationException {
		ToStringBuiltin builtin = new ToStringBuiltin(term, Y);
