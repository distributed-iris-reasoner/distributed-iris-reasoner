...
public class ToDayTimeDurationBuiltinTest extends TestCase {
	...
	public void testDayTimeDuration() throws EvaluationException {
		equals(CONCRETE.createDayTimeDuration(false, 2, 2, 3, 0), CONCRETE
	...
	public void testDuration() throws EvaluationException {
		equals(CONCRETE.createDayTimeDuration(true, 0, 5, 4, 2.3), CONCRETE
	...
	public void testYearMonthDuration() throws EvaluationException {
		equals(CONCRETE.createDayTimeDuration(true, 0, 0, 0, 0), CONCRETE
				.createYearMonthDuration(true, 2009, 4));
	}

	private void equals(IDayTimeDuration expected, ITerm term)
