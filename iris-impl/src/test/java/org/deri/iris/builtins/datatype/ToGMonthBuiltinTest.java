...
/**
 * Test for ToGMonthBuiltin.
 */
public class ToGMonthBuiltinTest extends TestCase {

	private static final ITerm X = TERM.createVariable("X");

	private static final ITerm Y = TERM.createVariable("Y");

	public ToGMonthBuiltinTest(String name) {
		super(name);
	}
	...
	public void testDate() throws EvaluationException {
		equals(CONCRETE.createGMonth(4), CONCRETE.createDate(2009, 04, 27));
		equals(CONCRETE.createGMonth(4), CONCRETE
				.createDate(2009, 04, 27, 5, 0));
	}

	public void testDateTime() throws EvaluationException {
		equals(CONCRETE.createGMonth(4), CONCRETE.createDateTime(2009, 04, 27,
				10, 10, 0, -5, 0));
	}
	...
	public void testGMonth() throws EvaluationException {
		equals(CONCRETE.createGMonth(4), CONCRETE.createGMonth(4));
	}
	...
	private ITuple compute(ITerm term) throws EvaluationException {
		ToGMonthBuiltin builtin = new ToGMonthBuiltin(term, X);
