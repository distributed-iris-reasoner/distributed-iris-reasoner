...
/**
 */
public class IsUnsignedByteBuiltinTest extends AbstractBooleanBuiltinTest {

	public IsUnsignedByteBuiltinTest(String name) {
		super(name);
	}
	...
	public void testBuiltin() throws SecurityException,
		...
		String builtinName = IsUnsignedByteBuiltin.class.getName();
		
		try {
			CONCRETE.createUnsignedByte((short) -2);
		...
		checkBuiltin(iri, term, builtinName, 
				...
				IsUnsignedShortBuiltin.class.getName());
	}
}