...
/**
 * Test for ToGMonthDayBuiltin.
 */
public class ToGMonthDayBuiltinTest extends TestCase {
	...
	public void testDate() throws EvaluationException {
		equals(CONCRETE.createGMonthDay(4, 27), CONCRETE.createDate(2009, 04,
				27));
		equals(CONCRETE.createGMonthDay(4, 27), CONCRETE.createDate(2009, 04,
				27, 5, 0));
	}
	...
	public void testDateTime() throws EvaluationException {
		equals(CONCRETE.createGMonthDay(4, 27), CONCRETE.createDateTime(2009,
				04, 27, 10, 10, 0, -5, 0));
	}
	...
	public void testGMonthDay() throws EvaluationException {
		equals(CONCRETE.createGMonthDay(4, 27), CONCRETE.createGMonthDay(4, 27));
	}
