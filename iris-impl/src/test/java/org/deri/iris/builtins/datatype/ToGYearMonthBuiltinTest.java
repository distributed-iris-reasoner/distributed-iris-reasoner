...
/**
 * Test for ToGYearMonthBuiltin.
 */
public class ToGYearMonthBuiltinTest extends TestCase {
	...
	public void testDate() throws EvaluationException {
		equals(CONCRETE.createGYearMonth(2009, 4), CONCRETE.createDate(2009,
				04, 27));
		equals(CONCRETE.createGYearMonth(2009, 4), CONCRETE.createDate(2009,
				04, 27, 5, 0));
	}
	...
	public void testDateTime() throws EvaluationException {
		equals(CONCRETE.createGYearMonth(2009, 4), CONCRETE.createDateTime(
				2009, 04, 27, 10, 10, 0, -5, 0));
	}
	...
	public void testGYearMonth() throws EvaluationException {
		equals(CONCRETE.createGYearMonth(2009, 4), CONCRETE.createGYearMonth(
				2009, 4));
	}
