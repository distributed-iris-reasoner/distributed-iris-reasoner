...
/**
 * Test for ToFloatBuiltin.
 */
public class ToFloatBuiltinTest extends TestCase {

	private static final ITerm X = TERM.createVariable("X");

	private static final ITerm Y = TERM.createVariable("Y");

	public ToFloatBuiltinTest(String name) {
		super(name);
	}
	...
	public void testBoolean() throws EvaluationException {
		equals(0.0f, CONCRETE.createBoolean(false));
		equals(1.0f, CONCRETE.createBoolean(true));
	}
	...
	public void testDecimal() throws EvaluationException {
		equals(1.337f, CONCRETE.createDecimal(1.337));
	}

	public void testDouble() throws EvaluationException {
		equals(1.337f, CONCRETE.createDouble(1.337));
	}
	...
	public void testFloat() throws EvaluationException {
		equals(1.3f, CONCRETE.createFloat(1.3f));
	}
	...
	public void testInteger() throws EvaluationException {
		equals(1337.0f, CONCRETE.createInteger(1337));
	}
	...
	public void testString() throws EvaluationException {
		equals(1.337f, TERM.createString("1.337"));
	...
	private void equals(float expected, ITerm term) throws EvaluationException {
		ITuple expectedTuple = BASIC
				.createTuple(CONCRETE.createFloat(expected));
	...
	private ITuple compute(ITerm term) throws EvaluationException {
		ToFloatBuiltin builtin = new ToFloatBuiltin(term, Y);
