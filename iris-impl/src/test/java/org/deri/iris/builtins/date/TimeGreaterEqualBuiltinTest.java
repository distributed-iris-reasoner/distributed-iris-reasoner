...
/**
 */
public class TimeGreaterEqualBuiltinTest extends AbstractDateBuiltinTest {

	public TimeGreaterEqualBuiltinTest(String name) {
		super(name);
	}
	...
	public void testBuiltin() throws EvaluationException {
		...
		// time1 = time1
		TimeGreaterEqualBuiltin builtin = new TimeGreaterEqualBuiltin(X,Y);
		...
		// time1 = time2
		builtin = new TimeGreaterEqualBuiltin(X,Y);
