...
/**
 */
public class XMLLiteralNotEqualBuiltinTest extends TestCase {
	...
	public XMLLiteralNotEqualBuiltinTest(String name) {
		super(name);
	}
	...
	public void testBuiltin() throws EvaluationException {
		...
		XMLLiteralNotEqualBuiltin builtin = new XMLLiteralNotEqualBuiltin(term1,term1);
		ITuple actualTuple = builtin.evaluate(arguments);
		assertEquals(null, actualTuple);

		builtin = new XMLLiteralNotEqualBuiltin(term1, term2);
		actualTuple = builtin.evaluate(arguments);
		assertEquals(null, actualTuple);

		builtin = new XMLLiteralNotEqualBuiltin(term1, term3);
		actualTuple = builtin.evaluate(arguments);
