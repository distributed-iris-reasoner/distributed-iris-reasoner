...
/**
 * Test for ToDurationBuiltin.
 */
public class ToDurationBuiltinTest extends TestCase {

	private static final ITerm X = TERM.createVariable("X");

	private static final ITerm Y = TERM.createVariable("Y");

	public ToDurationBuiltinTest(String name) {
		super(name);
	}
	...
	public void testDayTimeDuration() throws EvaluationException {
		equals(CONCRETE.createDuration(false, 0, 0, 2, 2, 3, 0), CONCRETE
	...
	public void testDuration() throws EvaluationException {
		equals(CONCRETE.createDuration(true, 2, 1, 0, 5, 4, 2.3), CONCRETE
	...
	public void testYearMonthDuration() throws EvaluationException {
		equals(CONCRETE.createDuration(true, 2009, 4, 0, 0, 0, 0), CONCRETE
				.createYearMonthDuration(true, 2009, 4));
	}

	private void equals(IDuration expected, ITerm term)
	...
	private ITuple compute(ITerm term) throws EvaluationException {
		ToDurationBuiltin builtin = new ToDurationBuiltin(term, Y);
