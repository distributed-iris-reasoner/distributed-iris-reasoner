 ...
 */
public class ToTimeBuiltinTest extends TestCase {
	...
	public void testDateTime() throws EvaluationException {
		equals(CONCRETE.createTime(8, 36, 25, -3, -33), CONCRETE
				.createDateTime(2009, 04, 28, 8, 36, 25, -3, -33));
	}
	...
	public void testTime() throws EvaluationException {
		equals(CONCRETE.createTime(12, 45, 0, 0, 0), CONCRETE.createTime(12,
				45, 0, 0, 0));
	}
	...
	private void equals(ITime expected, ITerm term) throws EvaluationException {
