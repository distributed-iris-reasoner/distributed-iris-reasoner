...
/**
 * Test for ToDateBuiltin.
 */
public class ToDateBuiltinTest extends TestCase {
	...
	public void testDate() throws EvaluationException {
		equals(CONCRETE.createDate(2009, 04, 27), CONCRETE.createDate(2009, 04,
				27));
	}

	public void testDateTime() throws EvaluationException {
		equals(CONCRETE.createDate(2009, 04, 27), CONCRETE.createDateTime(2009,
				04, 27, 10, 10, 0, -5, 0));
	}
	...
	private void equals(IDateTerm expected, ITerm term)
