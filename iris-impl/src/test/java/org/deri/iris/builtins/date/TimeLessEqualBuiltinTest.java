...
/**
 */
public class TimeLessEqualBuiltinTest extends AbstractDateBuiltinTest {

	public TimeLessEqualBuiltinTest(String name) {
		super(name);
	}
	...
	public void testBuiltin() throws EvaluationException {
		...
		// time1 = time1
		TimeLessEqualBuiltin builtin = new TimeLessEqualBuiltin(X,Y);
