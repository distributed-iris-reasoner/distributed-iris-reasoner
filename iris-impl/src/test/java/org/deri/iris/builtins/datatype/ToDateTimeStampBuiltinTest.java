...
public class ToDateTimeStampBuiltinTest extends TestCase {
	...
	public void testDate() throws EvaluationException {
		equals(CONCRETE.createDateTimeStamp(2009, 04, 27, 0, 0, 0, 0, 0), CONCRETE
				.createDate(2009, 04, 27));
		equals(CONCRETE.createDateTimeStamp(2009, 04, 27, 0, 0, 0, 5, 0), CONCRETE
				.createDate(2009, 04, 27, 5, 0));
	}

	public void testDateTime() throws EvaluationException {
		equals(CONCRETE.createDateTimeStamp(2009, 04, 27, 10, 10, 0, -5, 0),
				CONCRETE.createDateTime(2009, 04, 27, 10, 10, 0, -5, 0));
	}
	
	public void testDateTimeStamp() throws EvaluationException {
		equals(CONCRETE.createDateTimeStamp(2009, 04, 27, 10, 10, 0, -5, 0),
				CONCRETE.createDateTimeStamp(2009, 04, 27, 10, 10, 0, -5, 0));
	}
