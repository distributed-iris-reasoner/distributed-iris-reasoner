...
public class Generator {
  ...
  public static void main(String[] args) {
    ...
    new Generator().start(univNum, startIndex, seed, daml, ntriple, ontology);
  }
   ...
   */
  public void start(int univNum, int startIndex, int seed, boolean daml, boolean ntriple,
                    String ontology) {
    ...
    if (daml)
      ...
      writer_ = new NTripleWriter(this);
    else
